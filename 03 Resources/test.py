...
if __name__ == "__main__":
    ...
    # --- Peringatan Keamanan ---
    print("\n" + "="*60)
    print("PERINGATAN: Kode ini HANYA untuk tujuan EDUKASI memahami DES.")
    print("JANGAN gunakan implementasi ini atau DES untuk keamanan data nyata.")
    print("DES tidak aman karena panjang kunci yang pendek (56-bit).")
    print("Gunakan algoritma modern seperti AES.")
    print("="*60)
